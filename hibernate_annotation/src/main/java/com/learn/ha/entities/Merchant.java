...
public class Merchant implements Serializable{
	...
	public String toString() {
		return "Merchant [merchantNo=" + merchantNo + ", merchantName=" + merchantName + ", businessName="
				+ businessName + ", businessType=" + businessType + ", contactNo=" + contactNo + ", emailAddress="
				+ emailAddress + ", establishedDate=" + establishedDate + ", location=" + location + "]";
	}
